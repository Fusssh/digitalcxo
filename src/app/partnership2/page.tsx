            ...
            <aside className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
              <div className="bg-[#1C1C1C] rounded-2xl p-6 sm:p-8 border border-neutral-800 shadow-xl space-y-6">
                ...
                <div className="border-t border-neutral-800 pt-6 space-y-5">
                  ...
                  <div className="space-y-5 text-neutral-200">
                    <div className="flex items-start gap-3.5">
                      ...
                      <div>
                        <p className="font-bold text-white text-base sm:text-lg">Targeted CXO Engagement</p>
                        <p className="text-neutral-300 text-sm sm:text-base mt-1 leading-relaxed">Direct dialogue with CIOs, CISOs, and CTOs in high-trust closed environments.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3.5">
                      ...
                      <div>
                        <p className="font-bold text-white text-base sm:text-lg">Executive Thought Leadership</p>
                        <p className="text-neutral-300 text-sm sm:text-base mt-1 leading-relaxed">Keynote sessions, masterclass video podcasts, and joint whitepaper publishing.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3.5">
                      ...
                      <div>
                        <p className="font-bold text-white text-base sm:text-lg">Cross-Sector Reach</p>
                        <p className="text-neutral-300 text-sm sm:text-base mt-1 leading-relaxed">Presence across BFSI, ITES, Telecom, HealthTech, Aerospace, and Defense.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-neutral-800 pt-5 flex items-center gap-3 text-base text-neutral-300">
                  ...
                  <span>Strategic Alliances: <strong className="text-neutral-100 font-semibold">contact@digitalcxos.com</strong></span>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      {errors.presenceInIndia && (
                        <p className="text-rose-400 text-xs sm:text-sm mt-1">{errors.presenceInIndia.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between pb-2 border-b border-neutral-800">
                      ...
                      <span className="text-xs sm:text-sm text-neutral-300">Select one or more tracks</span>
                    </div>

                    {errors.preferredEngagementTypes && (
                      <p className="text-rose-400 text-xs sm:text-sm">{errors.preferredEngagementTypes.message}</p>
                    )}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="space-y-1">
                              <p className={cn("text-base font-bold", isSelected ? "text-[#C9A227]" : "text-white")}>
                                {opt.title}
                              </p>
                  ...
                  <div className="space-y-4 pt-4 border-t border-neutral-800">
                    ...
                    {errors.professionalConductConsent && (
                      <p className="text-rose-400 text-xs sm:text-sm pl-8">{errors.professionalConductConsent.message}</p>
                    )}
                    ...
                    {errors.privacyConsent && (
                      <p className="text-rose-400 text-xs sm:text-sm pl-8">{errors.privacyConsent.message}</p>
                    )}
                  </div>
